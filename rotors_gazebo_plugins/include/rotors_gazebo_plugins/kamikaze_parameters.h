...
#ifndef ROTORS_GAZEBO_PLUGINS_KAMIKAZE_PARAMETERS_H_
#define ROTORS_GAZEBO_PLUGINS_KAMIKAZE_PARAMETERS_H_
...
struct KAMIKAZEAerodynamicParameters {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  KAMIKAZEAerodynamicParameters()
...
struct KAMIKAZEVehicleParameters {
  KAMIKAZEVehicleParameters()
...
#endif /* ROTORS_GAZEBO_PLUGINS_KAMIKAZE_PARAMETERS_H_ */
